...
(async function () {
  ...
  const html = path.join(root, "docs", "Peoples-Bakers-Project-Guide-English-Advanced.html");
  const pdf = path.join(root, "docs", "Peoples-Bakers-Project-Guide-English-Advanced.pdf");
  const desktop = path.join(
    process.env.USERPROFILE || "",
    "Desktop",
    "Peoples-Bakers-Project-Guide-English-Advanced.pdf"
  );
